...
fs.readFile(filename, 'utf8', function(err, dataStr) {
    ...
    var mapArray = [];
    // refseq acc, pdb chain, offset to get prd resi = subj - query, subj start, subj end of pdb resi
    // no data for: YP_009724393, YP_009724394, YP_009725255, YP_009725302, YP_009725318
...
*/
    ...
    mapArray.push('YP_009724390 6XR8_A 0 1 1273');
    mapArray.push('YP_009724390 7CWM_A 0 1 1273');
    mapArray.push('YP_009724390 6ZWV_A 0 1 1273');
    ...
    mapArray.push('YP_009724390 6X79_A 19 32 1230');
    mapArray.push('YP_009724390 6XF5_A -11 3 1197');
    mapArray.push('YP_009724390 6XKL_A 0 1 1208');
    mapArray.push('YP_009724390 6XLU_A -13 1 1195');
    mapArray.push('YP_009724390 6XS6_A 0 1 1210');
    mapArray.push('YP_009724390 6ZB4_A 0 1 1213');
    mapArray.push('YP_009724390 6ZOW_A 0 1 1273');
    mapArray.push('YP_009724390 6ZOX_A -9 4 1202');
    mapArray.push('YP_009724390 6ZOY_A -9 4 1202');
    mapArray.push('YP_009724390 6ZP0_A -9 4 1202');
    mapArray.push('YP_009724390 6ZP1_A -9 4 1202');
    mapArray.push('YP_009724390 7A25_A 0 1 1146');
    mapArray.push('YP_009724390 7A4N_A 0 1 1208');
    mapArray.push('YP_009724390 7A5R_A 31 32 1256');
    mapArray.push('YP_009724390 7A91_A 31 32 716');
    mapArray.push('YP_009724390 7BBH_A -8 677 1217');
    mapArray.push('YP_009724390 7CAB_A 0 1 1208');
    mapArray.push('YP_009724390 7CAI_A 0 1 1208');
    mapArray.push('YP_009724390 7CHH_A 0 1 1208');
    mapArray.push('YP_009724390 7CN9_A -13 1 1127');
    mapArray.push('YP_009724390 7CWS_O -13 1 1134');
    mapArray.push('YP_009724390 7DCC_E 0 1 1208');
    mapArray.push('YP_009724390 7JJI_A 0 1 1273');
    mapArray.push('YP_009724390 7JWB_A 0 1 1208');
    mapArray.push('YP_009724390 7K8S_A 0 1 1213');
    mapArray.push('YP_009724390 7KDG_A 0 1 1208');
    mapArray.push('YP_009724390 7KDI_A 0 1 1208');
    mapArray.push('YP_009724390 7KDJ_A 0 1 1208');
    mapArray.push('YP_009724390 7KDK_A 0 1 1208');
    mapArray.push('YP_009724390 7KJ2_A -13 1 1195');
    mapArray.push('YP_009724390 7KL9_A 0 1 1208');
    mapArray.push('YP_009724390 7KMB_G -15 1 1193');
    mapArray.push('YP_009724390 7L02_A -26 1 1121');
    ...
    mapArray.push('YP_009724396 7JTL_A -14 4 107');
    mapArray.push('YP_009724396 7JX6_A -17 1 104');
    ...
    mapArray.push('YP_009725297 6KL2_A -32 114 144');
    mapArray.push('YP_009725297 7CDZ_A -37 1 137');
    mapArray.push('YP_009725297 7CE0_A -247 7 116');
    ...
    mapArray.push('YP_009725299 5RS7_A -204 3 169');
    mapArray.push('YP_009725299 5RVJ_A -201 5 173');
    mapArray.push('YP_009725299 6Z5T_A -203 3 176');
    mapArray.push('YP_009725299 7C33_A -202 5 175');
    mapArray.push('YP_009725299 7CJD_A -744 2 320');
    mapArray.push('YP_009725299 7CJM_B -744 2 316');
    mapArray.push('YP_009725299 7CMD_A -744 2 319');
    mapArray.push('YP_009725299 7D47_A -745 1 317');
    mapArray.push('YP_009725299 7D6H_A -740 5 320');
    mapArray.push('YP_009725299 7JRN_A -745 1 315');
    mapArray.push('YP_009725299 7KAG_A 0 1 111');
    mapArray.push('YP_009725299 7KG3_A -204 3 169');
    mapArray.push('YP_009725299 7KQW_A -201 5 173');
    ...
    mapArray.push('YP_009725301 2YNA_A 3 73 253');
    mapArray.push('YP_009725301 3D23_A 2 3 249');
    mapArray.push('YP_009725301 4RSP_A 3 73 253');
    mapArray.push('YP_009725301 4WMD_A 0 73 253');
    mapArray.push('YP_009725301 4YLU_A 0 73 253');
    mapArray.push('YP_009725301 5WKJ_A 10 80 261');
    mapArray.push('YP_009725301 6JIJ_A -2 46 246');
    mapArray.push('YP_009725301 6W2A_A 7 8 310');
    mapArray.push('YP_009725301 6XHL_A 1 2 307');
    mapArray.push('YP_009725301 6XMK_A 4 5 309');
    mapArray.push('YP_009725301 6XOA_A 0 1 306');
    mapArray.push('YP_009725301 7AKU_A 0 1 305');
    mapArray.push('YP_009725301 7AOL_A 0 1 306');
    mapArray.push('YP_009725301 7AR5_A 0 1 306');
    mapArray.push('YP_009725301 7C2Q_A -2 1 296');
    mapArray.push('YP_009725301 7C2Y_A 0 1 298');
    mapArray.push('YP_009725301 7CBT_A 27 28 333');
    mapArray.push('YP_009725301 7CWC_A 4 5 310');
    mapArray.push('YP_009725301 7JOY_A 0 1 306');
    mapArray.push('YP_009725301 7JPZ_A 0 1 306');
    mapArray.push('YP_009725301 7JR4_A 0 1 306');
    mapArray.push('YP_009725301 7KFI_A 3 4 309');
    mapArray.push('YP_009725301 7KVG_A 8 9 314');
    ...
    mapArray.push('YP_009725303 6XEZ_C 5 6 88');
    mapArray.push('YP_009725303 6XQB_C 1 2 84');
    mapArray.push('YP_009725303 7D4F_C 1 2 84');
    mapArray.push('YP_009725303 7JLT_A 1 2 84');
    ...
    mapArray.push('YP_009725304 6XEZ_B 1 2 199');
    mapArray.push('YP_009725304 6XQB_B 1 2 199');
    ...
    mapArray.push('YP_009725305 6WC1_A 3 4 116');
    ...
    mapArray.push('YP_009725306 7JYY_B 2 3 141');
    ...
    mapArray.push('YP_009725307 6XEZ_A 0 1 932');
    mapArray.push('YP_009725307 6XQB_A 1 2 933');
    mapArray.push('YP_009725307 7AAP_A 0 1 932');
    mapArray.push('YP_009725307 7CXM_A 0 1 932');
    mapArray.push('YP_009725307 7D4F_A 1 2 933');

    mapArray.push('YP_009725308 6JYT_A 2 3 603');
    mapArray.push('YP_009725308 5WWP_A 2 3 592');

    mapArray.push('YP_009725307 6ZSL_A 2 3 603');
    mapArray.push('YP_009725307 5RL6_A 0 1 601');
    mapArray.push('YP_009725307 6XEZ_E 4 5 605');
    ...
    mapArray.push('YP_009725310 5S6X_A 3 4 349');
    mapArray.push('YP_009725310 6VWW_A 24 25 370');
    mapArray.push('YP_009725310 7K0R_A 16 17 362');
    mapArray.push('YP_009725310 7K9P_A 3 4 349');
    ...
    mapArray.push('YP_009725311 7JYY_A 2 3 300');
